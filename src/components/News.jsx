        ...
        <Wrapper>
            {isSuccess ?
                <div className="flex flex-col">
                    ...
                    <h1 className="font-bold flex text-3xl truncate lg:justify-between items-center flex-nowrap text-red-700 my-4 mx-4 lg:after:w-4/5 lg:after:h-1 lg:after:block after:bg-red-700 ">Trending News</h1>
