                ...
                <div>
                    {
                        data.length > 0 ?
                            ...
                            <div className="text-red-700 text-4xl font-bold text-center flex justify-center items-center h-screen w-full flex-col gap-5">
                                ...
                                <button className="bg-red-700 px-2 py-4 m-4 text-white font-semibold hover:bg-gray-600  text-sm"><Link to='/'>Go Back to Home Page</Link></button>
                            </div>
                    }
                </div> : <div className="h-screen w-full text-red-700 flex justify-center items-center text-3xl font-bold">Loading....</div>
        }
