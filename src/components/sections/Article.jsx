    ...
    return <Wrapper>
        {articleData !== null ?
            <div className="m-5">
                ...
                <div>
                    <h1 className="font-semibold text-2xl lg:w-3/5 my-3">{articleData.title}</h1>
                    <p className="font-bold text-gray-400 text-base"> Published at: {articleData.publishedAt}</p>
                    <div className="lg:w-3/4 h-auto mt-3"><img src={articleData.urlToImage} alt="articleImage" className=" object-cover w-full h-full" /></div>
                    <h2 className="text-gray-400 italic text-xl lg:w-1/2 my-3">{articleData.description}</h2>
